...
export default class BookingPeriodField extends DateTimeRangeField {
    ...
    forFormInitialValue(value) {
        ...
        return value.map((item) => item ? moment(item) : null);
    }
    ...
    forForm() {
        ...
        yupChain = yupChain.test(
            ...
            function (value) {
                ...
                if (![bookingStatus.PROGRESS, bookingStatus.BOOKED].includes(status)) {
                    return true;
                }

                return BookingService.isPeriodAvailable(arrival, departure, id);
            }
        )
