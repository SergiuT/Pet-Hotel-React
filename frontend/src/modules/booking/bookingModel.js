...
import BookingPeriodField from './bookingPeriodField';
...
const fields = {
  ...
  status: new EnumeratorField('status', label('status'), [
    { id: bookingStatus.BOOKED, label: enumeratorLabel('status', bookingStatus.BOOKED) },
    { id: bookingStatus.PROGRESS, label: enumeratorLabel('status', bookingStatus.PROGRESS) },
    { id: bookingStatus.CANCELLED, label: enumeratorLabel('status', bookingStatus.CANCELLED) },
    { id: bookingStatus.COMPLETED, label: enumeratorLabel('status', bookingStatus.COMPLETED) },
  ], {
    "required": true
  }),
